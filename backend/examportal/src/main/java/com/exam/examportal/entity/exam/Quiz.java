package com.exam.examportal.entity.exam;
...
public class Quiz {
	...
	public Quiz(long qid, String title, String description, String maxMarks, String numberOfQuetions, boolean active,
	...
	public String toString() {
		return "Quiz [qid=" + qid + ", title=" + title + ", description=" + description + ", maxMarks=" + maxMarks
				+ ", numberOfQuetions=" + numberOfQuetions + ", active=" + active + ", category=" + category
				+ ", questions=" + questions + "]";
	}
